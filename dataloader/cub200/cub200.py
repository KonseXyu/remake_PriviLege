...
class CUB200(Dataset):
    ...
    def _pre_operate(self, root):
        ...
        if self.train:
            for k in train_idx:
                ...
                image_path = os.path.normpath(image_path)  # <-- 添加此行
    ...
    def SelectfromTxt(self, data2label, index_path):
        ...
        for i in index:
            ...
            img_path = os.path.normpath(img_path)  # <-- 添加此行
...
if __name__ == '__main__':
    txt_path = "D:/Code/pythonCode/PriViLege/data/index_list/cub200/session_1.txt"
    base_class = 100
